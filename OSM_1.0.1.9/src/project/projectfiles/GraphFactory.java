...
public class GraphFactory extends JPanel {
	...
	public GraphFactory(String dataTitle, String graphTitle, String xLabel, String yLabel, Object[][] data) {
        ...
        //export
        final JPanel export = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        ...
        add(headerPanel);
        //add export Button
        export.setPreferredSize(new Dimension(780, 75));
        add(export);
        //add chart
