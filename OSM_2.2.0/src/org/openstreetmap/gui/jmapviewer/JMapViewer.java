...
import project.projectfiles.DefendView;
import project.projectfiles.PlaneView;
import project.projectfiles.SerpentView;
...
import org.openstreetmap.gui.jmapviewer.DefultMapController;
    ...
    protected void initializeZoomSlider() {
        ...
        zoomSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                if (zoomSlider.getValue() <= MAX_ZOOM && zoomSlider.getValue() >= MIN_ZOOM)
