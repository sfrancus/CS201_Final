            ...
            if(carView instanceof CarView)
            {
               if(((CarView) carView).contains(alpha)){
                  ...
                  if(a == 0)
                  {
                      ...
                      if (!played){ 
                      Object[] options1 = { "Ok"};
                      int c = JOptionPane.showOptionDialog(null, "Is this Ace Pilot Miller? We've got a problem! Giant winged sea serpents are coming in from the Pacific to destroy CS201! You've got to do something! Go chop them up in your propeller!",
